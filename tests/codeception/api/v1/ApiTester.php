...
class ApiTester extends \Codeception\Actor
{
     ...
     * will not have the deleted_at header in its request.
     *
     * Example:
     * ```php
     * <?php
     ...
     * ``` php
     * <?php
     * $I->deleted_atir('vendor');
     * ?>
     * ```
     *
     * @param $dirname
     * @see \Codeception\Module\Filesystem::deleted_atir()
     */
    public function deleted_atir($dirname) {
        return $this->scenario->runStep(new \Codeception\Step\Action('deleted_atir', func_get_args()));
    }
